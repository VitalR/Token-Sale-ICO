...
contract('ArtToken', function(accounts) {
    ...
    it('initializes the contract with the correct values', function() {
        return ArtToken.deployed().then(function(instance) {
            ...
            assert.equal(name, 'Art Token', 'has the correct name')
    ...
    it('handles delegated token transfers', function() {
        return ArtToken.deployed().then(function(instance) {
            ...
            // Transfer some tokens fromAccount
            ...
            // Try transferrring something larger than the approved amount
            ...
            assert.equal(allowance.toNumber(), 0, 'deducts the amoutn from the allowance')
        })
    })
})